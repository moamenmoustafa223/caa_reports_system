...
<div class="mobile-container">
    ...
    <div class="back-header">
        <a href="{{ route('employee.department-reports.index') }}" class="back-btn">
                ...
                @foreach ($report->trackings as $tracking)
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content">
                            ...
                            @endif
                            @if ($tracking->changedBy)
                                <div class="timeline-user">
                                    <i class="fas fa-user"></i> {{ trans('back.by') }}:
    ...
    <div class="action-footer mb-3">
        <a href="{{ route('employee.department-reports.index') }}" class="btn-back-full">
