...
<div class="mobile-container">
    ...
    <div class="page-header">
        <h5 style="margin: 0; font-weight: 600;">{{trans('back.department_reports')}}</h5>
        <a href="{{ route('employee.index') }}" class="back-btn">
    ...
    <div class="filter-section">
        <form action="{{ route('employee.department-reports.index') }}" method="GET">
            <div class="filter-row">
                ...
                <a href="{{ route('employee.department-reports.index') }}" class="filter-btn secondary">
            ...
            @foreach($reports as $report)
                <div class="report-card">
                    ...
                    <div class="report-footer">
                        <a href="{{ route('employee.department-reports.show', $report->id) }}" class="view-btn">
    ...
    @else
        <div class="empty-state">
            ...
            <div class="empty-text">
                @if (app()->getLocale() == 'ar')
                    لا توجد بلاغات في القسم حتى الآن
                @else
