...
<head>
    <meta charset="utf-8" />
    <title>{{ trans('auth.Employee_Login') }} | حارس السلامة الذكي</title>
...
<body>
    <div class="login-container">
        ...
        <div class="login-card">
            ...
            <form method="POST" action="{{ route('employee_login_store') }}" id="loginForm">
                @csrf

                <div class="form-group">
                    <label class="form-label" for="phone">{{ trans('auth.username') }}</label>
                    <div class="input-wrapper">
                        <input type="text" class="form-input" name="phone" id="phone" required autofocus
                            placeholder="{{ trans('auth.username') }}" value="{{ old('phone') }}">
